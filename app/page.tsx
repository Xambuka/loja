...
export default function Home() {
  ...
  // Chamar getProdutosDestaque passando o ID de alguma empresa, por exemplo a primeira em destaque:
const produtosDestaque = empresasDestaque.length > 0 
  ? getProdutosDestaque(empresasDestaque[0].id) 
  : [];
